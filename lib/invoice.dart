...
//     // Add the font file to your assets and pubspec.yaml, e.g.:
...
//     } catch (_) {
//       // Fallback: will render Urdu with default, shaping may not be perfect.
//       urduFont = null;
//     }
...
//           crossAxisAlignment: CrossAxisAlignment.start,
//           children: [
//             // ====== Top Header (Bilingual, Urdu right, English left) ======
//             Row(
//               children: [
//                 const Expanded(
//                   child: Align(
...
//               crossAxisAlignment: CrossAxisAlignment.start,
//               children: const [
//                 Text('1. Without bill no medicine and other items will return/change.'),
//                 Text('2. Purchase medicine only return and change in 15 days, after not possible.'),
//                 Text('3. Insulins, vaccines, fridge items, cosmetics, children grooming items, damaged medicine, seal open syrup, test strips, sugar strips.'),
//                 Text('4. Check medicine and money return on counter, after no claim will be accepted.'),
//                 Text('5. Use medicine with doctor’s advice. In case of misuse we are not responsible.'),
//               ],
//             ),

//             const SizedBox(height: 12),

//             // ====== Bottom Row (Counter person + Thank You) ======
//             Row(
            ...
            children: [
              ...
              pw.Column(
                ...
                children: [
                  ...
                  pw.Text(
                    '2. Return/change possible in 15 days otherwise not possible.',
                  ),
                  pw.Text(
                    '3. Insulins, vaccines, fridge items, cosmetics, children grooming items, damaged medicine, Sugar strips were not return and change.',
                  ),
                  pw.Text(
                    '4. Check medicine and money at counter otherwise no claim will be accepted.',
                  ),
                  pw.Text(
                    '5. Use medicine with doctor advised; in case of medicine misuse , side effects we were not responsible.',
                  ),
                ],
              ),
