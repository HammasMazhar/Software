...
class _RequiredstocksState extends State<Requiredstocks> {
  ...
  // compute match score for search sorting
  ...
  Future<void> _exportToExcel() async {
    ...
    const sheetName = "Required Stocks";
    ...
    for (var key in requiredBox.keys) {
      final stock = Map<String, dynamic>.from(requiredBox.get(key));
      sheet.appendRow([
          ...
          content: SizedBox(
            ...
            child: DynamicForm(
              ...
              onSubmit: (values) {
                ...
                requiredBox.put(key, updatedStock);
                Navigator.pop(context);
                setState(() {});
              },
            ),
                  ...
                  builder: (context, constraints) {
                    ...
                    return SingleChildScrollView(
                      child: PaginatedDataTable(
                        ...
                        source: _RequiredStockDataSource(
                          filteredKeys,
                          box,
                          _editStocks,
                          _deleteStocks,
...
class _RequiredStockDataSource extends DataTableSource {
