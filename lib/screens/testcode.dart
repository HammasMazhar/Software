...
// }
 // void _saveBillData() {
  //   if (activeBill.isEmpty) return;

  //   bills[activeBill]!["customer"] = customerController.text;
  //   bills[activeBill]!["counterPerson"] = counterPersonController.text;
  //   bills[activeBill]!["discountAmount"] =
  //       double.tryParse(discountAmountController.text) ?? 0.0;
  //   bills[activeBill]!["discountPercent"] =
  //       double.tryParse(discountPercentController.text) ?? 0.0;
  //   // bills[activeBill]!["total"] = double.tryParse(totalController.text) ?? 0.0;
  // }
